...
public class Main {
    public static void main(String[] args) {
        ...
        // ------------------------------------------------------------------------------------
        // The code below is for the booking details.
        // ------------------------------------------------------------------------------------
        ...
        if (accommodations.containsKey(AccommodationID)) {
            // Gets the accommodation that the user wants.
            Accommodation selectedAcc = accommodations.get(AccommodationID);

            // The IF statment is used fir checking id the accommodation is booked.
            if (!selectedAcc.getIsBooked()) {
                System.out.println("Great! The accommodation is available.");

                // Marks the accommodation as booked.
                selectedAcc.bookAccommodation();

                //  Here the price is calculated and then the program creates the booking.
                ...
                // Output the message to inform the user that the accommodation is unavailable.
